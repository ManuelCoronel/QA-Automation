...
public class Constants {
	...
	private Constants() {
		...
		constantDir.put("endpoint user-GET", "/public/v2/users/283220");
		constantDir.put("Endpoint Post Go Rest", "/public/v2/users/");
		constantDir.put("Endpoint Delete Go Rest", "/public/v2/users/283220");
		constantDir.put("Endpoint user-Patch", "/public/v2/users/283220");
		
		
		constantDir.put("token", "6a91c50e40a0eb96ea649ed2dec68de3dc88bb373aa54bc7dde1317d2d527069");
		...
		constantDir.put("Endpoint Get restful", "/objects/8");
